...
public class LeaveService extends BaseService {
	...
	public Leave get(String id) {
		...
		if (historicProcessInstance!=null) {
			...
			variables = runtimeService.getVariables(runtimeService.createProcessInstanceQuery().processInstanceId(leave.getProcessInstanceId())
	...
	public void save(Leave leave, Map<String, Object> variables) {
		...
		ProcessInstance processInstance = runtimeService.startProcessInstanceByKeyAndTenantId(ActUtils.PD_LEAVE[0], businessKey, variables, TenantConfig.getCacheTenant());
