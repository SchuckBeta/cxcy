 ...
 *
 */
package com.oseasy.act.modules.act.entity;
...
import com.oseasy.act.modules.act.utils.Variable;
...
public class Act extends BaseEntity<Act> {
    ...
    private Map<String, String> map; // add By zhangzheng 查询map
                                     // key是查询的字段，value是查询的值
    ...
    public void setProcIns(ProcessInstance procIns) {
        ...
        if (procIns != null && procIns.getBusinessKey() != null) {
            String[] ss = procIns.getBusinessKey().split(StringUtil.MAOH);
