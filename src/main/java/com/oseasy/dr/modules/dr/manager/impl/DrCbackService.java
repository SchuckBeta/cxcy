 ...
 */
@Service
public class DrCbackService implements IManager, IManagerExt {
    ...
    public ApiTstatus<DrCardRparam> runner(DrCardParam param) {
        ...
        try {
            ...
            CardFactory.getCardManager(this).deleteCard(Long.valueOf(param.getCard().getNo()), CardFactory.getCommandDetial(param.getEtpId()), rparam);
        } catch (Exception e) {
