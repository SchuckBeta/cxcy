 ...
 */
@Service
public class DrCbackListService implements IManager, IManagerExt {
    ...
    public Integer getOperType() {
        return OperType.BLACK_LIST.getKey();
    }
    ...
    public ApiTstatus<DrCardRparam> runner(DrCardParam param) {
        ...
        try {
            ...
            CardFactory.getCardManager(this).updateCardState(param.getCard(), CardFactory.getCommandDetial(param.getEtpId()), rparam);
        } catch (Exception e) {
