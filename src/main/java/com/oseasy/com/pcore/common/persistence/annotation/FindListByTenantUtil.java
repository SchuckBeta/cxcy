 ...
 *
 */
public class FindListByTenantUtil {
    /**
     * 检查类指定方法是否存在@FindListByTenant注解.
     * @param mstr 方法签名
     */
        ...
        try {
            ...
            for(String classNames : classNameList){
                ...
                for (Method method : methods) {
                    ...
                    if (method.isAnnotationPresent(FindListByTenant.class) && (method.getAnnotation(FindListByTenant.class) != null)) {
                        return true;
                    }
                }
            }
