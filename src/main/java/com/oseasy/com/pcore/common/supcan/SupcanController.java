 ...
 *
 */
package com.oseasy.com.pcore.common.supcan;
...
import com.oseasy.com.pcore.common.supcan.treelist.TreeList;
import com.oseasy.com.pcore.common.supcan.treelist.cols.Col;
import com.oseasy.com.pcore.common.supcan.treelist.cols.Group;
import com.oseasy.com.pcore.common.supcan.treelist.cols.SupCol;
import com.oseasy.com.pcore.common.supcan.treelist.cols.SupGroup;
...
public class SupcanController extends BaseController {
	...
	public TreeList treeList(@PathVariable("typeAlias") String typeAlias) {
		...
		boolean useCache = CoreSval.getConfig("supcan.useCache") == "true";
		if (useCache) {
