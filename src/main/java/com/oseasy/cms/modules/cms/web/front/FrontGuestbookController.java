...
public class FrontGuestbookController extends BaseController{
	...
	public String guestbook(@RequestParam(required=false, defaultValue="1") Integer pageNo,
		...
		return CmsSval.path.vms(CmsEmskey.CMS.k()) + "front/themes/"+site.getCmsSiteconfig().getTheme()+"/frontGuestbook";
	}
...
//		}
		return CoreSval.REDIRECT+CoreSval.getFrontPath()+"/guestbook";
	}
