...
public class GuestbookController extends BaseController {
	...
	public String list(Guestbook guestbook, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return CmsSval.path.vms(CmsEmskey.CMS.k()) + "guestbookList";
	}
	...
	public String form(Guestbook guestbook, Model model) {
		...
		return CmsSval.path.vms(CmsEmskey.CMS.k()) + "guestbookForm";
	}
	...
	public String save(Guestbook guestbook, Model model, RedirectAttributes redirectAttributes) {
		...
		return CoreSval.REDIRECT + adminPath + "/cms/guestbook/?repage&status=2";
	}
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/ajaxGbookTypes", method = RequestMethod.GET, produces = "application/json;charset=utf-8")
    public ApiTstatus<String> ajaxGbookTypes() {
        return new ApiTstatus<String>(true, "查询成功！", (Arrays.asList(GbookType.values())).toString());
    }
}
