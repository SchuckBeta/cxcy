 ...
 *
 */
package com.oseasy.cms.modules.si.web;
...
public class SiController extends BaseController{
	...
	public String home() {
		System.out.println(CmsSval.path.vss(CmsSval.StEmskey.SI.k()) + "siIndex");
		return CmsSval.path.vss(CmsSval.StEmskey.SI.k()) + "siIndex";
	}

	@RequestMapping(value = "{id}/indexs")
	public String app(@PathVariable String app) {
		System.out.println(CmsSval.path.vss(CmsSval.StEmskey.SI.k(), app) + app + "Index");
		return CmsSval.path.vss(CmsSval.StEmskey.SI.k(), app) + app + "Index";
	}

	@RequestMapping(value = "{id}/app")
	public String app(@PathVariable String app, @RequestParam(value = "id", required = true) String id) {
		System.out.println(CmsSval.path.vss(CmsSval.StEmskey.SI.k(), id) + app + "index");
		return CmsSval.path.vss(CmsSval.StEmskey.SI.k(), id) + app + "index";
	}
}
