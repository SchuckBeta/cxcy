 ...
 * @version 2018-06-05
 */
public class ProModelMdGc extends WorkFetyPm<ProModelMdGc> implements IWorkRes, IWorkDaoety{
	...
	public ProModelMdGc(String id){
		super(id);
	}

	public ProModelMdGc(List<String> ids) {
        super(ids);
    }
    ...
    public ProModelMdGc(List<String> ids, String actYwId) {
        super(ids, actYwId);
    }
