 ...
 * @author chenhao
 */
public class ItCkXgPromEnter implements IitCheck<ItCparamPm>{
    public final static Logger logger = Logger.getLogger(ItCkXgPromEnter.class);
    private String format;

    public ItCkXgPromEnter(String format) {
        super();
        this.format = format;
    }
