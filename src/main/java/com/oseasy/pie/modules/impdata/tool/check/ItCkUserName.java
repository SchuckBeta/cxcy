 ...
 * @author chenhao
 */
public class ItCkUserName implements IitCheck<ItCparamDr>{
    public final static Logger logger = Logger.getLogger(ItCkUserName.class);
    ...
    public ItCparamDr validate(ItCparamDr param, IitCheckEetyExt pe, IitCheckEetyExt pev) {
        ...
        if((pe instanceof DrCardError) && (pev instanceof DrCardError)){
            ...
            phe.setTmpName(param.getVal());
            validinfo.setTmpName(phe.getTmpName());
