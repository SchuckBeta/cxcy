 ...
 *
 */
public class ItDnConGcontestPro implements IitDownTpl{

    public static Logger logger = Logger.getLogger(ItDnConGcontestPro.class);

    private Boolean isDefault;//没有业务节点，使用默认模板和头
    private ActYw actYw;

    public ItDnConGcontestPro() {
        super();
        this.isDefault = true;
    }

    public ItDnConGcontestPro(ActYw actYw) {
        super();
        this.actYw = actYw;
    }
