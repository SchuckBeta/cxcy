 ...
 * @author chenhao
 */
public class ItCkUnational implements IitCheck<ItCparamUser>{
    public final static Logger logger = Logger.getLogger(ItCkUnational.class);

    public ItCkUnational() {
        super();
    }
    ...
    public ItCparamUser validate(ItCparamUser param, IitCheckEetyExt pe, IitCheckEetyExt pev) {
        ...
        phe.setNational(param.getVal());
        validinfo.setNational(param.getVal());
        ...
        if (StringUtil.isNotEmpty(param.getVal())) {
            if ((param.getVal()).length() > 64) {
                ...
                phe.setNational(null);
                validinfo.setNational(null);
            }
        }
        ...
        if (StringUtil.isNotEmpty(iie.getErrmsg())) {
            ...
            param.getUser().setNational(param.getVal());
        }
        return param;
    }
}