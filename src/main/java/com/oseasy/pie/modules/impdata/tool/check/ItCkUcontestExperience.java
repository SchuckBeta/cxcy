 ...
 * @author chenhao
 */
public class ItCkUcontestExperience implements IitCheck<ItCparamUser>{
    public final static Logger logger = Logger.getLogger(ItCkUcontestExperience.class);

    public ItCkUcontestExperience() {
        super();
    }
    ...
    public ItCparamUser validate(ItCparamUser param, IitCheckEetyExt pe, IitCheckEetyExt pev) {
        ...
        phe.setContestExperience(param.getVal());
        validinfo.setContestExperience(param.getVal());
        ...
        if (StringUtil.isNotEmpty(iie.getErrmsg())) {
            ...
            param.getStudent().setContestExperience(param.getVal());
        }
        return param;
    }
}