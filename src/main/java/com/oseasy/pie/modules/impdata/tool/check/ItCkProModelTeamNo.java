 ...
 *
 */
public class ItCkProModelTeamNo implements IitCheck<ItCparamPm>{
    public final static Logger logger = Logger.getLogger(ItCkProModelTeamNo.class);

    private UserService userService;

    public ItCkProModelTeamNo(UserService userService) {
        super();
