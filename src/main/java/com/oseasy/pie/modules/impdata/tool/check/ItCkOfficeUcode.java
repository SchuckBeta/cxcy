 ...
 *
 */
public class ItCkOfficeUcode implements IitCheck<ItCparamPm>{
    public static Logger logger = Logger.getLogger(ItCkOfficeUcode.class);
    ...
    public ItCparamPm validate(ItCparamPm param, IitCheckEetyExt pe, IitCheckEetyExt pev) {
        ...
        phe.setUniversityCode(param.getVal());
        validinfo.setUniversityCode(param.getVal());
