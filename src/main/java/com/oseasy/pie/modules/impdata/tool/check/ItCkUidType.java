 ...
 * @author chenhao
 */
public class ItCkUidType implements IitCheck<ItCparamUser>{
    public final static Logger logger = Logger.getLogger(ItCkUidType.class);
    ...
    public ItCparamUser validate(ItCparamUser param, IitCheckEetyExt pe, IitCheckEetyExt pev) {
        ...
        phe.setIdType(param.getVal());
        validinfo.setIdType(param.getVal());
        ...
        if (StringUtil.isNotEmpty(param.getVal())) {
            if ((d = DictUtils.getDictByLabel(SysSval.DICT_ID_TYPE, param.getVal())) == null) {
        ...
        if (StringUtil.isNotEmpty(iie.getErrmsg())) {
            ...
            if (d != null){
                param.getUser().setIdType(d.getValue());
            }
        }
        return param;
    }
