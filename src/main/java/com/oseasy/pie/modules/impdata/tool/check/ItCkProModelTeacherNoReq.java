 ...
 *
 */
public class ItCkProModelTeacherNoReq implements IitCheck<ItCparamPm>{
    public final static Logger logger = Logger.getLogger(ItCkProModelTeacherNoReq.class);

    private UserService userService;

    public ItCkProModelTeacherNoReq(UserService userService) {
        super();
