 ...
 * @author chenhao
 */
public class ItCkUserOfficeZy implements IitCheck<ItCparamDr>{
    public final static Logger logger = Logger.getLogger(ItCkUserOfficeZy.class);

    public ItCkUserOfficeZy() {
        super();
    }
    ...
    public ItCparamDr validate(ItCparamDr param, IitCheckEetyExt pe, IitCheckEetyExt pev) {
        ...
        if((pe instanceof DrCardError) && (pev instanceof DrCardError)){
            ...
            validinfo.setProfessional(phe.getProfessional());
