 ...
 *
 */
public class ItCkProModelTeacherName implements IitCheck<ItCparamPm>{
    public final static Logger logger = Logger.getLogger(ItCkProModelTeacherName.class);

    private XSSFRow rowData;

    public ItCkProModelTeacherName(XSSFRow rowData) {
        super();
