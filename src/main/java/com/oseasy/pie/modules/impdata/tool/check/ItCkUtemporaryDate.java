 ...
 * @author chenhao
 */
public class ItCkUtemporaryDate implements IitCheck<ItCparamUser>{
    public final static Logger logger = Logger.getLogger(ItCkUtemporaryDate.class);

    public ItCkUtemporaryDate() {
        super();
    }
    ...
    public ItCparamUser validate(ItCparamUser param, IitCheckEetyExt pe, IitCheckEetyExt pev) {
        ...
        phe.setTemporaryDate(param.getVal());
        validinfo.setTemporaryDate(param.getVal());
        ...
        if (StringUtil.isNotEmpty(iie.getErrmsg())) {
            ...
            param.getStudent().setTemporaryDate(curDate);
        }
        return param;
    }
}