...
import com.oseasy.pie.modules.impdata.dao.ConStuErrorDao;
...
public class ConStuErrorService extends CrudService<ConStuErrorDao, ConStuError> {
    @Autowired
    private SysSystemService systemService;
	public List<Map<String,String>> getListByImpId(String impid) {
		return dao.getListByImpId(impid);
	}
	public ConStuError get(String id) {
		return super.get(id);
	}

	public List<ConStuError> findList(ConStuError studentError) {
		return super.findList(studentError);
	}

	public Page<ConStuError> findPage(Page<ConStuError> page, ConStuError studentError) {
		return super.findPage(page, studentError);
	}

	@Transactional(readOnly = false)
	public void save(ConStuError studentError) {
		super.save(studentError);
	}
	@Transactional(readOnly = false)
	public void insert(ConStuError studentError) {
	...
	@Transactional(readOnly = false)
	public void delete(ConStuError studentError) {
