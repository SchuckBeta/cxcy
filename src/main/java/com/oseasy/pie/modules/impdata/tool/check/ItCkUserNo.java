 ...
 * @author chenhao
 */
public class ItCkUserNo implements IitCheck<ItCparamDr>{
    public final static Logger logger = Logger.getLogger(ItCkUserNo.class);
    ...
    public ItCparamDr validate(ItCparamDr param, IitCheckEetyExt pe, IitCheckEetyExt pev) {
        ...
        if((pe instanceof DrCardError) && (pev instanceof DrCardError)){
            ...
            phe.setTmpNo(param.getVal());
            validinfo.setTmpNo(phe.getTmpNo());
