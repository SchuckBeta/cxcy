 ...
 * @author chenhao
 */
public class ItCkUenterdate implements IitCheck<ItCparamUser>{
    public final static Logger logger = Logger.getLogger(ItCkUenterdate.class);

    public ItCkUenterdate() {
        super();
    }
