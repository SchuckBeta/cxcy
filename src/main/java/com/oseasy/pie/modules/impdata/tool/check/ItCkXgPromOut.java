 ...
 * @author chenhao
 */
public class ItCkXgPromOut implements IitCheck<ItCparamPm>{
    public final static Logger logger = Logger.getLogger(ItCkXgPromOut.class);
    private String format;

    public ItCkXgPromOut(String format) {
        super();
        this.format = format;
    }
