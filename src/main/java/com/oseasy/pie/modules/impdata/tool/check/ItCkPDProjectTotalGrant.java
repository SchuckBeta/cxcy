 ...
 *
 */
public class ItCkPDProjectTotalGrant implements IitCheck<ItCparamPm>{
    public static Logger logger = Logger.getLogger(ItCkPDProjectTotalGrant.class);
    ...
    public ItCparamPm validate(ItCparamPm param, IitCheckEetyExt pe, IitCheckEetyExt pev) {
        ...
        phe.setTotalGrant(param.getVal());
        validinfo.setTotalGrant(param.getVal());
