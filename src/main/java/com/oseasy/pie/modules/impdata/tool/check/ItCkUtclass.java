 ...
 * @author chenhao
 */
public class ItCkUtclass implements IitCheck<ItCparamUser>{
    public final static Logger logger = Logger.getLogger(ItCkUtclass.class);
    ...
    public ItCparamUser validate(ItCparamUser param, IitCheckEetyExt pe, IitCheckEetyExt pev) {
        ...
        phe.setTClass(param.getVal());
        validinfo.setTClass(param.getVal());
        ...
        if (StringUtil.isNotEmpty(iie.getErrmsg())) {
            ...
            param.getStudent().setTClass(param.getVal());
        }
        return param;
    }
}