 ...
 *
 */
public class ItCkPDProjectUniversityGrant implements IitCheck<ItCparamPm>{
    public static Logger logger = Logger.getLogger(ItCkPDProjectUniversityGrant.class);
    ...
    public ItCparamPm validate(ItCparamPm param, IitCheckEetyExt pe, IitCheckEetyExt pev) {
        ...
        phe.setUniversityGrant(param.getVal());
        validinfo.setUniversityGrant(param.getVal());
