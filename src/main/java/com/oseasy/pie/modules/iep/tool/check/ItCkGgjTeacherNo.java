 ...
 *
 */
public class ItCkGgjTeacherNo implements IitCheck<ItCparamGgj>{
    public final static Logger logger = Logger.getLogger(ItCkGgjTeacherNo.class);

    private UserService userService;

    public ItCkGgjTeacherNo(UserService userService) {
        super();
