Vue.component('pro-view-gc', {
    ...
    '              <e-col-item label="项目简介："><span class="white-space-pre" v-html="proModel.introduction"></span></e-col-item></e-col-con>\n' +
    ...
    '           <div class="pro-vmb-tab-wrap">\n' +
    '                 <div class="pro-tab-cate-title"><span>团队介绍</span></div>' +
    '                 <e-col-item label-width="20px"><span class="white-space-pre" v-html="team.summary"></span></e-col-item><div class="pro-tab-cate-title"><span>团队成员</span></div>\n' +
