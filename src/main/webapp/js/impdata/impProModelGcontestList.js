$(document).ready(function() {
	...
	$('#fileToUpload').on('change', function() {
		...
		if((tplType != '') && (tplType != undefined)){
			url = '/a/impdata/importProModelGcontestData?actywId=' + $("#actywId").val() + '&gnodeId=' + $("#gnodeId").val() + "&hasFile=1&tplType="+tplType
		}else{
