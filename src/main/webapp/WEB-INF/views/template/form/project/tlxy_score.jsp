...
<div id="app" v-show="pageLoad" style="display: none" class="container-fluid mgb-60">
    ...
    <div class="pro-contest-content panel-padding-space">
        <el-tabs class="pro-contest-tabs" v-model="tabActiveName">
            ...
            <el-tab-pane label="评分" name="five">
                <e-panel label="评分">
                    <score-form label="评分" :action="scoreAction" @submit-complete="submitComplete">
...
<script>
    ...
    new Vue({
        ...
        computed: {
            ...
            scoreAction:{
                get:function () {
                    return this.delegateExpert == '1' ? this.frontOrAdmin + '/promodel/proModel/promodelDelegateAudit' : this.frontOrAdmin + '/promodel/proModel/promodelGateAudit'
                }
            }
        },
        methods: {
