...
<div id="app" v-show="pageLoad" style="display: none" class="container-fluid mgb-60">
    ...
    <div class="panel panel-project mgb-20">
        ...
        <div class="panel-body">
            ...
            <div class="project-info_list">
                ...
                <e-col-item label="项目类型：" align="right" style="margin-bottom: 10px;">{{proModel.proCategory |
    ...
    <div class="pro-contest-content panel-padding-space  mgb-20">
        <div class="btn-audit-box">
            <el-button type="primary" size="mini" :disabled="disabled" @click.stop="openAuditForm">评分</el-button>
        </div>
            ...
            <el-tab-pane label="项目信息" name="second">
                <e-panel label="项目基本信息">
                    <el-row :gutter="20" label-width="110px">
                        ...
                        <el-col :span="24">
                            <e-col-item label="项目简介：">
                                <span class="white-space-pre" v-html="proModel.introduction"></span>
                            </e-col-item>
                        </el-col>
                    </el-row>
                </e-panel>
                ...
                <e-panel :label="item.gnodeName || 'gnodeName'" v-if="reports.length > 0" v-for="item in reports" :key="item.id">
                    ...
                    <el-row :gutter="20" label-width="150px" style="margin-left:53px;">
                        <el-col :span="20">
                            <e-col-item label="已取得阶段性成果："><span class="white-space-pre" v-html="item.stageResult"></span></e-col-item>
                        </el-col>
                    </el-row>
                </e-panel>
            </el-tab-pane>
    ...
    <el-dialog title="审核"
        ...
        <promodel-audit-form ref="promodelAuditForm" :pro-model="proModel" is-score :options="[]" :disabled="disabled" @submit-before="disabled = true" @submit-success="dialogVisibleAudit = false" @submit-complete="disabled=false"></promodel-audit-form>
        ...
        computed: {
            sourceRules: {
                get: function () {
                    ...
                    return [{required: auditForm.grade === '0', message: '请填写建议及意见', trigger: 'blur'}]
                }
            },
