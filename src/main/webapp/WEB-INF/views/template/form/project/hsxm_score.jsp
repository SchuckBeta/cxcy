...
<div id="app" v-show="pageLoad" style="display: none" class="container-fluid mgb-60">
    ...
    <div class="pro-contest-content panel-padding-space">
        <div class="btn-audit-box">
            <el-button type="primary" size="mini" @click.stop="openAuditForm">评分</el-button>
        </div>
    ...
    <el-dialog title="评分"
        ...
        <promodel-audit-form ref="promodelAuditForm" is-score :pro-model="proModel" :options="[]" :task-name="avgName" :disabled="disabled" @submit-before="disabled = true" @submit-success="dialogVisibleAudit = false" @submit-complete="disabled=false"></promodel-audit-form>
