    ...
    <div class="clearfix">
        ...
        <div class="search-block_bar clearfix">
            <div class="search-btns">
                <el-button v-if=" isAdmin =='1' && isGate != null && isGate =='1'" type="primary"
                ...
                <button-export is-hsxm v-if="isAdmin =='1'" :spilt-prefs="spiltPrefs" :spilt-posts="spiltPosts"
                               label="项目"
                               :search-list-form="searchListForm"></button-export>

                <button-export-file is-hsxm v-if="isAdmin =='1'" :menu-name="menuName" label="项目"
