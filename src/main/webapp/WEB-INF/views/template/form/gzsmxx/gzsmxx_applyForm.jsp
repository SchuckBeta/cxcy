...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${ctxCss}/project/form.css"/>
    <link rel="stylesheet" type="text/css" href="${ctxCss}/md_applyForm.css">
...
<div class="container container-ct">
    ...
    <form:form id="competitionfm" modelAttribute="proModelGzxmxx" action="${ctxFront}/proprojectgzsmxx/proModelGzxmxx/ajaxSave" method="post" class="form-horizontal"
    ...
    <%--</form:form>
    <form:form id="competitionfmSecond" modelAttribute="proModelGzxmxx" action="${ctxFront}/proprojectgzsmxx/proModelGzxmxx/save" method="post" class="form-horizontal"
                enctype="multipart/form-data">--%>
        <div class="contest-content">
            <div class="tool-bar">
                <div class="inner">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-box">
                                <ul id="downFileUl" class="file-list">
                                    <li class="file-item">
                                        <div class="file-info">
                                            <img src="${ctxImg}/filetype/word.png">
...
<script src="${ctxJs}/gzsmxx/mdApplyBak.js?v=11" type="text/javascript" charset="utf-8"></script>
<script src="${ctxJs}/gzsmxx/findteam.js" type="text/javascript" charset="utf-8"></script>
