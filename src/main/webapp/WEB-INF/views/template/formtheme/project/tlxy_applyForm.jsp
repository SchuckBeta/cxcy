...
<div id="app" v-show="pageLoad" class="container page-container pdt-60" style="display: none">
    ...
    <el-form :model="proModelTlxyForm" ref="proModelTlxyForm" :rules="proModelTlxyRules" :disabled="disabled" autocomplete="off"
        ...
        <div class="apply-form-container">
            ...
            <div class="apply-form-body">
                ...
                <el-form-item label="项目来源：" prop="source">
                    <el-select v-model="proModelTlxyForm.source" clearable>
                ...
                <el-form-item label="项目Logo：" prop="proModel.logoUrl" class="common-upload-one-img">
                    <div class="upload-box-border site-logo-left-size">
                        ...
                        <div v-show="proModelTlxyForm.proModel.logoUrl && !disabled" class="arrow-block-delete"
                            ...
                            <tr>
                                <td>
                                    <el-form-item prop="planContent" label-width="0" :rules="requiredTextRules">
                                        <el-input type="textarea" v-model="proModelTlxyForm.planContent" :rows="3"
                                                  maxlength="2000"></el-input>
                                    </el-form-item>
                                </td>
                                <td>
                                ...
                                <td>
                                    <el-form-item prop="planStep" label-width="0" :rules="requiredTextRules">
                                        <el-input type="textarea" v-model="proModelTlxyForm.planStep" :rows="3"
                                                  maxlength="2000"></el-input>
                                    </el-form-item>
                                </td>
                            </tr>
                            ...
                            <tr v-for="(item, index) in proModelTlxyForm.planList">
                                ...
                                <td>
                                    <el-form-item>
                                        ...
                                        <br>
                                        <el-button v-show="proModelTlxyForm.planList.length > 1" icon="el-icon-minus"
    ...
    new Vue({
        ...
        methods: {
            proProjectApplyAble: function () {
                ...
                var proModel = this.proModelTlxy.proModel;
                var self = this;
                if (!this.isStudent) {
                    return false;
                }
...
//                        }).then(function () {
//                            location.href = '/f/proModelTlxy/applyStep2?id=' + data.id + '&actYwId=' + proModel.actYwId;
//                        }).catch(function () {
//
//                        });
                        self.proModelTlxy.id = data.id;
            ...
            getParams: function () {
                ...
                this.assignFormData(proModelTlxyFormParams, proModelTlxyForm);
                ...
                proModelTlxyFormParams = Object.toURLSearchParams(proModelTlxyFormParams);
            ...
            setproModelTlxyForm: function () {
                ...
                proModelTlxy.proModel.logoUrl = proModelTlxy.proModel.logo ? proModelTlxy.proModel.logo.tempUrl : '';
                proModelTlxy.proModel.subTime = proModelTlxy.proModel.subTime ? moment(proModelTlxy.proModel.subTime).format('YYYY-MM-DD') : '';
                this.proModelTlxyForm.proModel.declareId = this.loginCurUser.id;
