...
<div class="container project-view-contanier">
    ...
    <form:form id="competitionfm" modelAttribute="proModelMd" action="${ctxFront}/proprojectmd/proModelMd/ajaxSave" method="post"
...
<script src="${ctxJs}/md/mdApplyBak.js?v=12111" type="text/javascript" charset="utf-8"></script>
