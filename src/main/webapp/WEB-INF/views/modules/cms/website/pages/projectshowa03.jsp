...
<div class="container" style="margin-top: 40px;">
	...
	<div class="system_info">
		...
		<div class="system">
			<img src="${ctxImg}/pro-detail03.jpg" />
		</div>
...
<div class="introduction">
	<div class="introduction_info container">
		...
		<div class="xmone" style="width: 100%">
			<ul>
				<li>项目简介</li>
				<li><img src="${ctxImg}/pro-detail03.jpg"></li>
...
<div class="product container">
	...
	<div class="productdisplay" style="text-align: center">
		<img src="${ctxImg}/pro-detail-big0301.jpg" style="width: auto;max-width: 75%;height: auto;margin: 15px auto">
	</div>
	<div style="clear: both;"></div>
