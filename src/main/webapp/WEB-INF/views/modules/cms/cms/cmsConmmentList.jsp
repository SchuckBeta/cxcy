    ...
    <el-form :model="searchListForm" ref="searchListForm" size="mini">
        ...
        <div class="search-block_bar clearfix">
            ...
            <div class="search-input">
                <el-checkbox v-model="isAllChecked" v-if="articleList.length > 0" :indeterminate="isIndeterminate" @change="handleChangeIsAllChecked" style="margin: 3px 16px 0 25px;">全选</el-checkbox>
                <el-input
                        placeholder="请输入文章标题"
                        size="mini"
            ...
            <div v-for="article in articleList" :key="article.id" class="article-comments">
                <div class="article-comments-header">
                    <el-row>
                        ...
                        <el-col :span="10">
                            <div v-show="articleComments[article.id] && articleComments[article.id].length > 0" class="text-right">
                                <el-button size="mini" :icon="!article.isShow ? 'el-icon-arrow-up' : 'el-icon-arrow-down'" @click.stop="handleChangeIsShow(article)"></el-button>
                            </div>
                        </el-col>
                    </el-row>
                </div>
                <div class="article-comments-body control-article-comments">
                    <el-collapse-transition>
                        <div v-show="!article.isShow" style="width: 100%">
...
<script type="text/javascript">
    ...
    new Vue({
        ...
        methods: {
            ...
            handleChangeIsShow: function (artcle) {
                Vue.set(artcle, 'isShow', !artcle.isShow)
            },
