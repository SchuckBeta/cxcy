    ...
    <div class="clearfix">
        ...
        <div class="search-block_bar clearfix">
            <div class="search-btns">
                <el-button size="mini" :disabled="tableList.length < 1" icon="el-icon-sort" type="primary" @click.stop.prevent="saveSorts">保存排序
                </el-button>
                ...
                <el-tooltip class="item" content="请选择需要删除的大赛文章" :disabled="multipleSelectedId.length > 0"
    ...
    <el-dialog
        ...
        <div class="flow-reminder-content">
            <ul class="time-horizontal">
                <div>
                    <div class="flow-li3"><label>大赛管理系统</label></div>
                    <div class="flow-li3"><label>网站内容管理系统</label></div>
                </div>
                <li><b class="step-line">1</b><span>大赛查询</span></li>
                <li><b class="step-line">2</b><span>选择大赛</span></li>
