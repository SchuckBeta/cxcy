...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/gen/genTemplate/form?id=${genTemplate.id}">代码模板
			<%--<shiro:hasPermission name="gen:genTemplate:edit">--%>
			${not empty genTemplate.id?'修改':'添加'}
			<%--</shiro:hasPermission><shiro:lacksPermission name="gen:genTemplate:edit">--%>
			查看
