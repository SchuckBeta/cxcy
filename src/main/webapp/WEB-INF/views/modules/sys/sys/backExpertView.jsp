...
<div id="app" v-show="pageLoad" style="display: none" class="container-fluid mgb-60">
    <div class="mgb-20">
        <edit-bar second-name="详情" href="/sys/expert"></edit-bar>
    </div>
        ...
        <div class="user_detail-wrap">
            <div class="user_detail-inner">
                ...
                <el-row :gutter="10" label-width="90px">
                    <el-col :span="24">
                        <e-col-item label="专家来源：" align="right">{{teacherForm.expertType | checkboxFilter(expertSourcesEntries)}}</e-col-item>
                    </el-col>
                    <el-col :span="8">
...
<script type="text/javascript">
    ...
    new Vue({
        ...
        data: function () {
            ...
            var expertSources = JSON.parse(JSON.stringify(${fns: toJson(fns: getDictList("expert_source"))})) || [];
...
//            });
            ...
            console.log(teacherData,expertSources);
...
//                    userLoginName: user.loginName,
                    ...
                    roleIdList:backTeacherExpansion.roleIdList || [],
                    expertType:backTeacherExpansion.expertType || ''
                },
...
//                isDefaultCollegeRootId: false, //去掉学院;
                ...
                cpRoleListEntries:{
                    'ecee0da215d04186bdeea0373bf8eeea':'学校专家',
                    'ef8b7924557747e2ac71fe5b52771c08':'学院专家'
                }
            }
        },
        computed: {
