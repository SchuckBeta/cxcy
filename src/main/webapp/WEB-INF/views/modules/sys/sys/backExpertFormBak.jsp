        ...
        <div class="user_detail-wrap">
            <div class="user_detail-inner">
                ...
                <el-form :model="teacherForm" ref="teacherForm" :rules="teacherRules" autocomplete="off"
                    ...
                    <el-row :gutter="10">
                        <%--<el-col :span="8">--%>
                        <%--<el-form-item prop="teachertype" label="专家来源：">--%>
                        ...
                        <%--</el-col>--%>
                        <el-col :span="24">
                            <el-form-item label="专家来源：" prop="expertTypeList">
                        ...
                        <%--<el-checkbox-group v-model="teacherForm.roleIdList" name="roleIdList" :disabled="isRoleDisable">--%>
                        ...
                        <%--label="专家类型：">--%>
                        <%--<input v-if="teacherForm.serviceIntentionIds.indexOf('4') > -1" type="hidden"--%>
                        <%--name="category" :value="teacherForm.category">--%>
                        <%--<el-select :disabled="teacherForm.serviceIntentionIds.indexOf('4') == -1"--%>
                        <%--v-model="teacherForm.category" placeholder="请选择" clearable>--%>
                        <%--<el-option--%>
...
<script type="text/javascript">
    ...
    new Vue({
        ...
        data: function () {
            ...
            var masterTypes = JSON.parse(JSON.stringify(${fns:toJson(fns: getDictList('expert_type'))}));
...
//            });
            ...
            return {
                teacherForm: {
                    ...
                    expertTypeList: backTeacherExpansion.expertTypeList || [],
                    userName: user.name,
...
//                    var isCompanyMaster = this.teacherForm.teachertype === '2';
                    var isCompanyMaster = this.teacherForm.expertTypeList.length == 1 && this.teacherForm.expertTypeList.indexOf('2494442643c24193bc1aa480eddcf43f') > -1;
...
//                    var hasMasterType = this.teacherForm.serviceIntentionIds.indexOf('4') > -1;
                    ...
                    var validateUserProfessional = function (rule, value, callback) {
                        if (value.length > 0 && self.teacherForm.expertTypeList.indexOf('ef8b7924557747e2ac71fe5b52771c08') > -1 && self.collegeEntries[self.professionalId].grade != '3') {
                    ...
                    return {
                        'teachertype': [
                            {required: true, message: '请选择专家来源', trigger: 'blur'}
                        ],
                        'expertTypeList': [
                            {required: true, message: '请选择专家角色', trigger: 'change'}
                        ],
                        'userName': [
...
//                        'userProfessional': [
//                            {validator: validateUserProfessional, trigger: 'change'}
//                        ],
                        'userMobile': [
...
//                        'category': [
//                            {required: hasMasterType, message: '请选择专家类型', trigger: 'change'},
//                        ],
                        'userIdType': [
        ...
        watch: {
//            'teacherForm.teachertype': function (value) {
//                this.teacherForm.expertTypeList = [];
//                this.isRoleDisable = false;
//                if (value == '2') {
//                    this.teacherForm.expertTypeList = ['ecee0da215d04186bdeea0373bf8eeea'];
...
//                        loginName:this.teacherForm.userLoginName,
                    ...
                    expertTypeList: this.teacherForm.expertTypeList,
                    ...
                    this.$axios({
                        ...
                        if (data.status == '1') {
                            self.$msgbox({
                                ...
                                window.location.href = self.frontOrAdmin + '/sys/expert';
                            }).catch(function () {
...
//            if (this.teacherForm.teachertype == '2') {
//                this.isRoleDisable = true;
//            }
            if (this.saveMessage) {
