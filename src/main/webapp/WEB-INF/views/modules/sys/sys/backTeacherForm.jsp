...
<div id="app" v-show="pageLoad" style="display: none" class="container-fluid mgb-60">
    <div class="mgb-20">
        <edit-bar :second-name="teacherForm.id ? '编辑': '添加'" href="/sys/backTeacherExpansion"></edit-bar>
    </div>
            ...
            <div class="user_detail-inner">
                <div class="user_detail-title-handler">
                    <div class="ud-row-handler">
                        ...
                        <el-button :disabled="isUpdating" size="mini" @click.stop.prevent="goToBack">返回
                        </el-button>
                    </div>
                </div>
                <el-form :model="teacherForm" ref="teacherForm" autocomplete="off"
                    ...
                    <el-row :gutter="10">
                        <el-col :span="8">
                            <el-form-item prop="teachertype" label="导师来源：" :rules="teachertypeRules">
                        ...
                        <el-col :span="8">
                            <el-form-item prop="user.name" label="姓名：" :rules="userNameRules">
                                <el-input name="name" maxlength="15" v-model="teacherForm.user.name"
                                          placeholder="限15位字符"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                        ...
                        <el-col :span="8">
                            <el-form-item prop="user.no" label="职工号：" :rules="userAsStuNoRules">
                                <el-input v-model="teacherForm.user.no" maxlength="64" placeholder="限64位字符"></el-input>
                            </el-form-item>
                        </el-col>
                        ...
                        <el-col :span="8">
                            <el-form-item prop="user.national" label="民族：">
                                <el-input v-model="teacherForm.user.national" maxlength="24"
                                          placeholder="限24位字符"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                        ...
                        <el-col :span="24">
                            <el-form-item prop="serviceIntentionIds" label="服务意向："
                                          :rules="isCompanyMaster ? [] : serviceIntentionIdsRules">
                        ...
                        <el-col :span="8">
                            <el-form-item prop="educationType" label="学历类别："
                                          :rules="isCompanyMaster ? [] : educationTypeRules">
                        ...
                        <el-col :span="8">
                            <el-form-item prop="user.education" label="学历：">
                        ...
                        <el-col :span="8">
                            <el-form-item label="院系/专业：" prop="user.professionalIds" :rules="professionalTeaRules">
                                <el-cascader
                                        ref="cascader"
                                        :options="officeTree"
                                        :clearable="true"
                        ...
                        <el-col :span="8">
                            <el-form-item prop="industry" label="行业：">
                                <el-input name="industry" v-model="teacherForm.industry" maxlength="48"
                                          placeholder="限48位字符"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item prop="postTitle" label="职务：">
                                <el-input name="postTitle" v-model="teacherForm.postTitle" maxlength="48"
                                          placeholder="限48位字符"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                        ...
                        <el-col :span="8">
                            <el-form-item prop="firstBank" label="开户银行：">
                                <el-input name="firstBank" v-model="teacherForm.firstBank" maxlength="48"
                                          placeholder="限48位字符"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item prop="bankAccount" label="账号：">
                                <el-input name="bankAccount" v-model="teacherForm.bankAccount" maxlength="128"
                                          placeholder="限128位字符"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                        ...
                        <el-col :span="8">
                            <el-form-item prop="workUnit" label="工作单位：">
                                <el-input name="workUnit" v-model="teacherForm.workUnit" maxlength="128"
                                          placeholder="限128位字符"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item prop="recommendedUnits" label="推荐单位：">
                                <el-input name="recommendedUnits" v-model="teacherForm.recommendedUnits" maxlength="128"
                                          placeholder="限128位字符"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
...
//                isDefaultCollegeRootId: false, //去掉学院;
                ...
                teachertypeRules: [{required: true, message: '请选择导师来源', trigger: 'change'}],
        ...
        computed: {
            isCompanyMaster: function () {
                return this.teacherForm.teachertype === '2';
            },
                ...
                this.$axios.post('/sys/backTeacherExpansion/saveExpertOrTea', teacherForm).then(function (response) {
                    ...
                    if (data.status == '1') {
                        self.$msgbox({
                            ...
                            window.location.href = self.ctx + '/sys/backTeacherExpansion';
                        }).catch(function () {
