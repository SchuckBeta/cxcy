...
<div id="app" v-show="pageLoad" style="display: none">
    <div class="mgb-20">
        <edit-bar class="edit-bar-province" :second-name="teacherForm.id ? '编辑': '添加'"></edit-bar>
    </div>
            ...
            <div class="user_detail-inner">
                ...
                <el-form :model="teacherForm" ref="teacherForm" autocomplete="off"
                    ...
                    <el-row :gutter="10">
                        ...
                        <el-col :span="8">
                            <el-form-item prop="workUnit" label="工作单位：" :rules="requireBlurRules">
                        ...
                        <el-col :span="8">
                            <el-form-item prop="postTitle" label="职务：" :rules="requireChangeRules">
                        ...
                        <el-col :span="8">
                            <el-form-item prop="industry" label="行业：" :rules="requireChangeRules">
                        ...
                        <el-col :span="8">
                            <el-form-item prop="recommendedUnits" label="推荐机构：" :rules="requireChangeRules">
                        ...
                        <el-col :span="24">
                            <el-form-item label="技术领域：" prop="user.domainIdList" :rules="requireChangeRules">
                        ...
                        <el-col :span="24">
                            <el-form-item prop="serviceIntentionIds" label="服务意向：" :rules="requireChangeRules">
                        ...
                        <el-col :span="24" style="height: auto">
                            <el-form-item label="个人简历：" prop="mainExp" :rules="requireBlurRules">
...
//                isDefaultCollegeRootId: false, //去掉学院;
                ...
                requireBlurRules: [{required: true, message: '请输入', trigger: 'blur'}],
                requireChangeRules: [{required: true, message: '请选择', trigger: 'change'}],
                ...
                this.$axios.post('/sys/backTeacherExpansion/saveExpertOrTea', teacherForm).then(function (response) {
                    ...
                    if (data.status == '1') {
                        self.$msgbox({
                            ...
                            window.location.href = self.ctx + '/sys/backTeacherExpansion/toProvinceTeacherList';
                        }).catch(function () {
