...
<div id="app" v-show="pageLoad" style="display: none" class="container page-container pdt-60">
    <el-breadcrumb class="mgb-20" separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item><a href="${ctxFront}/sys/frontTeacherExpansion">导师资源</a></el-breadcrumb-item>
    ...
    <el-row :gutter="30">
            ...
            <el-row :gutter="30">
                <el-col :span="4">
                    <div class="user-detail-pic">
                        ...
                        <div v-if="user.id != loginCurUser.id && loginCurUser.id" class="text-right btn-like-action">
                ...
                <el-col :span="20">
                    <el-row :gutter="16" label-width="84px">
                        ...
                        <el-col :span="12">
                            <e-col-item label="导师来源：" align="right">{{backTeacherExpansion.teachertype |
                                selectedFilter(masterTypeEntries)}}
                            </e-col-item>
                        </el-col>
                        <el-col :span="12">
                            <e-col-item label="院系名称：" align="right">{{userProfessional |
                        ...
                        <el-col :span="24">
                            <e-col-item label="工作经历：" class="white-space-pre-static word-break" align="right"><span v-html="backTeacherExpansion.mainExp"></span></e-col-item>
                        </el-col>
                    </el-row>
                </el-col>
            </el-row>
        ...
        <el-col :span="5">
            <div class="user_detail-title-handler">
                <div class="ud-row-title"><span class="name">谁看过<template v-if="loginCurUser.id == user.id">我</template><template
