...
<div id="app" v-show="pageLoad" style="display: none" class="container page-container pdt-60">
    <el-breadcrumb class="mgb-20" separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item><a href="${ctxFront}/promodel/proModel/getTeacherAuditTaskList">导师审核</a></el-breadcrumb-item>
    ...
    <el-dialog title="审核"
        ...
        <promodel-audit-form ref="promodelAuditForm" is-front :pro-model="proModel" :options="actYwStatusList"  :disabled="disabled" @submit-before="disabled = true" @submit-success="dialogVisibleAudit = false" @submit-complete="disabled=false"></promodel-audit-form>
