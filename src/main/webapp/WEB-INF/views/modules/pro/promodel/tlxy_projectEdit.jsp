    ...
    <div class="pro-contest-content panel-padding-space mgb-20">
        ...
        <el-tabs class="pro-contest-tabs" v-model="tabActiveName">
            <el-tab-pane label="项目信息" name="firstCreditTab">
                <tab-pane-content>
                    <e-panel label="项目信息">
                        <el-form :model="proModelTlxyForm" ref="proModelTlxyForm" :rules="proModelTlxyRules"
                                 :disabled="disabled" autocomplete="off"
                                 size="mini" label-width="120px">
                            <el-form-item prop="proModel.subTime" label="申报日期：" inline-message>
                                <el-date-picker
                                        v-model="proModelTlxyForm.proModel.subTime"
                                        type="date"
                            ...
                            <el-form-item label="项目编号：" prop="proModel.competitionNumber">
                                <el-input v-model="proModelTlxyForm.proModel.competitionNumber" maxlength="24"
                                          class="w300"></el-input>
                            </el-form-item>
                            <el-form-item label="项目名称：" prop="proModel.pName">
                                <el-input v-model="proModelTlxyForm.proModel.pName" maxlength="128"
                                          placeholder="最多128个字符"></el-input>
                            </el-form-item>
                            <el-form-item label="项目类别：" prop="proModel.proCategory">
                                <el-select v-model="proModelTlxyForm.proModel.proCategory">
                                    <el-option v-for="item in projectStyles" :key="item.value" :value="item.value"
                                               :label="item.label"></el-option>
                                </el-select>
                            </el-form-item>
                            <el-form-item label="项目来源：" prop="source">
                                <el-select v-model="proModelTlxyForm.source">
                                    <el-option v-for="item in projectSources" :key="item.value" :value="item.value"
                                               :label="item.label"></el-option>
                                </el-select>
                            </el-form-item>
                            <%--<el-form-item label="项目级别：" prop="proModel.finalStatus">--%>
                                <%--<el-select v-model="proModelTlxyForm.proModel.finalStatus">--%>
                                    <%--<el-option v-for="item in levelDict" :key="item.value" :value="item.value"--%>
                                               <%--:label="item.label"></el-option>--%>
                                <%--</el-select>--%>
                            <%--</el-form-item>--%>
                                ...
                                <div class="upload-box-border site-logo-left-size">
                                    <div class="avatar-uploader">
                                        <div tabindex="0" class="el-upload el-upload--text"
                                            ...
                                            <img :src="proModelTlxyForm.proModel.logoUrl | ftpHttpFilter(ftpHttp) | proGConPicFilter">
                                        </div>
                                    </div>
                                    <div v-show="proModelTlxyForm.proModel.logoUrl && !disabled"
                                         class="arrow-block-delete"
                                         @click.stop="proModelTlxyForm.proModel.logoUrl = ''">
                            ...
                            <el-form-item prop="proModel.introduction" label="项目简介：">
                                <el-input type="textarea" v-model="proModelTlxyForm.proModel.introduction" :rows="3"
                            ...
                            <el-form-item prop="innovation" label="前期调研准备：">
                                <el-input type="textarea" v-model="proModelTlxyForm.innovation" :rows="3"
                                          maxlength="2000"></el-input>
                            </el-form-item>
                                        ...
                                        <tr>
                                            <td>
                                                <el-form-item prop="planContent" label-width="0"
                                                    ...
                                                    <el-input type="textarea" v-model="proModelTlxyForm.planContent"
                                                              :rows="3"
                                                              maxlength="2000"></el-input>
                                                </el-form-item>
                                            </td>
                                            <td>
                                                <el-form-item prop="planDateRange" label-width="0"
                                                    ...
                                                    <el-date-picker
                                                            v-model="proModelTlxyForm.planDateRange"
                                                            type="daterange"
                                                            unlink-panels
                                            ...
                                            <td>
                                                <el-form-item prop="planStep" label-width="0"
                                                              :rules="requiredTextRules">
                                                    <el-input type="textarea" v-model="proModelTlxyForm.planStep"
                                                              :rows="3"
                                                              maxlength="2000"></el-input>
                                                </el-form-item>
                                            </td>
                            ...
                            <el-form-item label="任务分工：" required>
                                <div class="table-container">
                                    <table class="el-table el-table--fit el-table--enable-row-hover el-table--enable-row-transition el-table--mini e-table-tree"
                                        ...
                                        <tbody>
                                        <tr v-for="(item, index) in proModelTlxyForm.planList">
                                            <td>
                                            ...
                                            <td>
                                                <el-form-item>
                                                    ...
                                                    <br>
                                                    <el-button v-show="proModelTlxyForm.planList.length > 1"
                                                               icon="el-icon-minus"
                                                               @click.stop="proModelTlxyForm.planList.splice(index, 1)"></el-button>
                                                </el-form-item>
                                            </td>
                                        </tr>
                                        </tbody>
                            ...
                            <el-form-item prop="resultType" label="成果形式：">
                                <el-checkbox-group v-model="proModelTlxyForm.resultType">
                            ...
                            <el-form-item prop="resultContent" label="成果说明：">
                                <el-input type="textarea" v-model="proModelTlxyForm.resultContent" :rows="3"
                                          maxlength="2000"></el-input>
                            </el-form-item>
                            <div style="margin: 0 -30px">
                                <div class="enter-form-group-titlebar">
                                    <span class="title">经费预算 <i class="el-icon-d-arrow-right"></i></span>
                                </div>
                            </div>
                            <el-form-item prop="budgetDollar" label="项目经费预算：">
                                <el-input v-model="proModelTlxyForm.budgetDollar" class="w300" maxlength="20">
                                    <template slot="append">元（人民币）</template>
                                </el-input>
                            </el-form-item>
                            <el-form-item prop="budget" label="经费预算明细：">
                                <el-input type="textarea" v-model="proModelTlxyForm.budget" :rows="3"
                            ...
                            <el-form-item label="团队名称：" required>{{proModelTlxy.proModel.team.name}}
                                <el-button type="text" @click.stop="openTeamChange">成员变更记录</el-button>
                            </el-form-item>
                            <update-member :declare-id="applyUser.id" :disabled="disabled" :first-teacher-id="proModelTlxy.proModel.team.firstTeacher"
                                           :team-id="proModelTlxy.proModel.teamId" is-admin
                            ...
                            <el-form-item v-if="changeGnodes.length > 0" label="变更流程到节点：" prop="toGnodeId">
                                <el-select v-model="proModelTlxyForm.proModel.toGnodeId" clearable filterable>
            ...
            <el-tab-pane label="审核记录" name="threeCreditTab">
                <tab-pane-content>
                    <promodel-audit-record :pro-model-id="proModelTlxy.proModel.id"></promodel-audit-record>
                </tab-pane-content>
            </el-tab-pane>
        </el-tabs>
    </div>
...
<script type="text/javascript">
    ...
    new Vue({
        ...
        data: function () {
            ...
            var levelDict = JSON.parse(JSON.stringify(${fns:getDictList(levelDict)}));
            ...
            var validatePName = function (rules, value, callback) {
                var proModelTlxyForm = self.proModelTlxyForm;
                var proModelForm = proModelTlxyForm.proModel;
                var params = {
                    id: proModelForm.id,
            ...
            var validateCompetitionNumber = function (rules, value, callback) {
                if (value) {
                    var proModelForm = self.proModelTlxyForm.proModel;
                    var params = {
                        id: proModelForm.id,
            ...
            return {
                ...
                proModelTlxyRules: {
                    ...
                    budgetDollar: [
                        {required: true, message: "请输入项目经费预算", trigger: 'blur'},
...
//                        ]
        ...
        computed: {
            ...
            applyDate: function () {
                return this.proModelTlxy.createDate
            },
        ...
        methods: {
            ...
            validateProModelForm: function () {
                ...
                return new Promise(function (resolve, reject) {
                    self.$refs.proModelTlxyForm.validate(function (valid, object) {
                        if (valid) {
                            resolve()
                        } else {
                            reject({
            ...
            validateAllForm: function () {
                ...
                var proModelTlxyForm = this.$refs.proModelTlxyForm;
                var promiseAll = [];
                reportsForm && promiseAll.push(this.validateReportsForm());
                proModelTlxyForm && promiseAll.push(this.validateProModelForm());
...
//                        }
            ...
            getParams: function () {
                var proModelTlxyForm = JSON.parse(JSON.stringify(this.proModelTlxyForm));
                var resultType = proModelTlxyForm.resultType;
                var resultTypeParams = [];
                var planListParams = this.getPlanListParams(proModelTlxyForm.planList);
                resultType.forEach(function (item) {
                    resultTypeParams.push('resultType=' + item);
                });
                resultTypeParams = resultTypeParams.join('&');

                var proModelTlxyParams = this.getproModelTlxyParams();
                ...
                var teamParams = this.getTeamParams();
                var params = [proModelTlxyParams, planListParams, resultTypeParams, proModelParams,stuTeaListParams, reportParams, sysAttachmentListParams];
                if(teamParams){
            ...
            getTeamParams: function () {
                var team = this.proModelTlxyForm.proModel.team;
                var entry = {};
                for (var k in team) {
                    if (team.hasOwnProperty(k)) {
                        entry['team.' + k] = team[k];
                    }
                }
            ...
            getproModelTlxyParams: function () {
                var proModelTlxyForm = JSON.parse(JSON.stringify(this.proModelTlxyForm));
                delete proModelTlxyForm.id;
                delete proModelTlxyForm.proModel;
                delete proModelTlxyForm.planList;
                delete proModelTlxyForm.resultType;
                delete proModelTlxyForm.planDateRange;
                delete proModelTlxyForm.sysAttachmentList;
                return Object.toURLSearchParams(proModelTlxyForm).toString();
            },
...
//                            }
            ...
            getActParams: function () {
                var act = this.proModelTlxyForm.proModel.act;
                var entry = {};
                for (var k in act) {
            ...
            getTeamUserChangeList: function () {
                var self = this;
                var params = {
                    proModelId: this.proModelTlxyForm.proModel.id,
                    teamId: this.proModelTlxyForm.proModel.teamId
                };
                this.$axios.post('/team/teamUserChange/ajax/getTeamUserChangeList?' + Object.toURLSearchParams(params)).then(function (response) {
                    var data = response.data;
                    if (data.ret == 1) {
            ...
            handleChangeTeam: function (data) {
                ...
                this.teacherList.forEach(function (item) {
                    if(item.teacherzz == '0'){
                        self.proModelTlxyForm.proModel.team.firstTeacher = item.userId;
                    }
                });
            },
            ...
            openDialogLogo: function () {
                var url = this.proModelTlxyForm.proModel.logoUrl;
            ...
            updateUserPic: function () {
                ...
                self.$axios({
                    ...
                    if (data.state === 'SUCCESS') {
                        self.proModelTlxyForm.proModel.logoUrl = data.ftpUrl;
            ...
            addPlanList: function () {
                this.proModelTlxyForm.planList.push(JSON.parse(JSON.stringify(this.defaultPlanL)))
            },

            handleChangePlanDateRange: function (value) {
                if (value && value.length > 0) {
                    this.proModelTlxyForm.planStartDate = value[0];
                    this.proModelTlxyForm.planEndDate = value[1];
                } else {
                    this.proModelTlxyForm.planStartDate = '';
                    this.proModelTlxyForm.planEndDate = '';
                }
            },

            handleChangeDateRange: function (index) {
                var proModelTlxyForm = this.proModelTlxyForm;
                var planList = proModelTlxyForm.planList;
            ...
            setproModelTlxyForm: function () {
                var proModelTlxy = this.proModelTlxy;
                var planStartDate = proModelTlxy.planStartDate;
                var planEndDate = proModelTlxy.planEndDate;
                var planList = proModelTlxy.planList || [];
                ...
                proModelTlxy.planList = planList.length > 0 ? planList : this.defaultPlanL;
                if (planStartDate) {
                    proModelTlxy.planStartDate = moment(planStartDate).format('YYYY-MM-DD HH:mm:ss');
                    proModelTlxy.planEndDate = moment(planEndDate).format('YYYY-MM-DD HH:mm:ss');
                    proModelTlxy.planDateRange = [proModelTlxy.planStartDate, proModelTlxy.planEndDate]
                }
                proModelTlxy.resultType = proModelTlxy.resultType ? proModelTlxy.resultType.split(',') : [];
                proModelTlxy.proModel.logoUrl = proModelTlxy.proModel.logo ? proModelTlxy.proModel.logo.tempUrl : '${logo.url}';
                proModelTlxy.proModel.subTime = proModelTlxy.proModel.subTime ? moment(proModelTlxy.proModel.subTime).format('YYYY-MM-DD') : '';
//                if(proModelTlxy.proModel.finalStatus == '0000000265'){
//                    proModelTlxy.proModel.competitionNumber = proModelTlxy.proModel.pCompetitionNumber;
//                }else if(proModelTlxy.proModel.finalStatus == '0000000266'){
//                    proModelTlxy.proModel.competitionNumber = proModelTlxy.proModel.gCompetitionNumber;
//                }
                this.assignFormData(this.proModelTlxyForm, proModelTlxy);
            },
