...
<div id="app" v-show="pageLoad" class="container-fluid mgb-60" style="display: none">
    ...
    <el-form :model="searchListForm" ref="searchListForm" size="mini">
        ...
        <div class="search-block_bar clearfix">
            <div class="search-btns">
                <el-tooltip content="请勾选需要删除的学分记录" :disabled="multipleSelection.length > 0" popper-class="white"
                            placement="top"><span><el-button :disabled="multipleSelection.length === 0" type="primary"
                                                             size="mini"
                                                             @click.stop="confirmDelScoCredits">批量删除</el-button></span>
                </el-tooltip>
            </div>
    ...
    <div class="table-container">
        <el-table v-loading="loading" :data="cpScrApplyList" size="mini" class="table"  @selection-change="handleSelectionChange" ref="multipleTable"
            ...
            <el-table-column  label="申请名称"  prop="projectName"  align="center">
                <template slot-scope="scope">
            ...
            <el-table-column prop="auditDate" label="认定日期" sortable="custom" align="center">
                <template slot-scope="scope">
                    {{scope.row.auditDate | formatDateFilter('YYYY-MM-DD HH:mm:ss')}}
                </template>
            </el-table-column>
...
<script type="text/javascript">
    ...
    new Vue({
        ...
        methods: {
            ...
            confirmDelScoCredits: function () {
                var self = this;
                this.$confirm('确认删除选中的学分申请记录以及包含的学分吗？', '提示', {
                    type: 'warning',
            ...
            delScoCredits: function () {
                var self = this;
                this.$axios.post('/scr/scoCreditQuery/ajaxPLDeleteScoCredit', this.multipleSelection.map(function (item) {
                    return {id: item.id}
            ...
            confirmDelApplyItem: function (item) {
                var self = this;
                this.$confirm('确认删除这条学分申请记录以及包含的学分吗？', '提示', {
                    type: 'warning',
                    confirmButtonText: '确定',
                    cancelButtonText: '取消'
                }).then(function () {
