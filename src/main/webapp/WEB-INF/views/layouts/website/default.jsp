...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${ctxOther}/jquery-ui-1.12.1/jquery-ui.css?v=2"/>
    <link rel="stylesheet" type="text/css" href="${ctxCss}/pagination.css">
    ...
    <link rel="stylesheet" type="text/css" href="${ctxCss}/common.css?v=10"/>
    ...
    <!--文本溢出-->
    <script type="text/javascript" src="${ctxJs}/team/mock-min.js"></script>
