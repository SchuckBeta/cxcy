...
<link rel="stylesheet" type="text/css" href="${ctxStatic}/bootstrap/2.3.1/css_united/bootstrap.min.css"/>
...
<link rel="stylesheet" type="text/css" href="${ctxCss}/backPagination.css"/>
<link rel="stylesheet" type="text/css" href="${ctxCss}/backCommon.css"/>
<link rel="stylesheet" type="text/css" href="${ctxStatic}/common/initiateNew.css"/>
...
<script src="${ctxJs}/validateMethods.js" type="text/javascript"></script>
<script src="${ctxJs}/backCommon.js" type="text/javascript"></script>
