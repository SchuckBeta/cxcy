...
<c:set var="tenantConfig" value="${fns: getTconfig()}"></c:set>
...
<c:if test="${tenantConfig.currpn eq '2'}">
    <link rel="stylesheet" href="${ctxStatic}/nprovince/element@2.3.8/index.theme.default.css?version=${fns: getVevison()}"/>
...
<c:if test="${tenantConfig.currpn eq '3' || tenantConfig.currpn eq '1'}">
    <link rel="stylesheet" href="${ctxStatic}/element@2.3.8/index.css">
    <link rel="stylesheet" href="${ctxCss}/common/common.bundle.css?version=${fns: getVevison()}">
    <link rel="stylesheet" href="${ctxCss}/cyjd/backCreative.bundle.css?version=${fns: getVevison()}">
</c:if>
...
<script src="${ctxJs}/globalUtils/bluebird.min.js"></script>
<!--兼容promise对象-->
...
<script src="${ctxJs}/components/passwordForm/passwordForm.js?version=${fns: getVevison()}"></script>
<!---修改密码-->
...
<script src="${ctxJs}/components/editBar/editBar.js"></script>
...
<script src="${ctxJs}/components/cropperPic/cropperPic.js"></script>
<!--图片裁剪-->
<script src="${ctxJs}/components/controlRuleBlock/controlRuleBlock.js"></script>
<script src="${ctxJs}/components/echart/echartBar.js"></script>
<script src="${ctxJs}/components/echart/echartPie.js"></script>
<script src="${ctxJs}/components/echart/echartLine.js"></script>
<script src="${ctxJs}/components/echart/echartBase.js"></script>
...
<script type="text/javascript"
        src="${ctxJs}/components/updateMember/updateMember.js?version=${fns: getVevison()}"></script>
<script type="text/javascript"
        src="${ctxJs}/components/pwEnter/pwEnterApplyRules.js?version=${fns: getVevison()}"></script>
<script type="text/javascript"
        src="${ctxJs}/components/pwEnter/pwEnterApplyForm.js?version=${fns: getVevison()}"></script>
...
<script type="text/javascript" src="${ctxJs}/components/scr/ruleMixins.js?version=${fns: getVevison()}"></script>
<script type="text/javascript" src="${ctxJs}/components/scr/scrCommon.js?version=${fns: getVevison()}"></script>
<script type="text/javascript" src="${ctxJs}/components/colProNode/colProNode.js"></script>
        ...
        Vue.mixin({
            data: function () {
                return {
                    ...
                    currTconfig: JSON.parse(JSON.stringify(${fns:getTconfig()})) || {},
                    currTenantId: '',
                    showActrel: false,
                    showTenantPop: true,
                    isShowTenant: true,
                    showOffice: false,
                    nprId: '20',
                    urvo: JSON.parse(JSON.stringify(${fns: toJson(fns:getUrvo())})) || {},
                    fileStepEnum: {'apply': '1102', 'middle': '1103', 'end': '1104'}
                }
            },
            computed: {
                isSchoolPlatform: function () {
                    return this.currTconfig.currpn === 3;
                },
                isProvincePlatform: function () {
                    return this.currTconfig.currpn === 2;
                },
                isCenterPlatform: function () {
                    return this.currTconfig.currpn === 1;
                }
            },
            methods: {
            ...
            created: function () {
                ...
                this.showActrel = this.currTconfig.showActrel;
                this.isShowTenant = this.currTconfig.isShowTenant;
                this.showOffice = this.currTconfig.showOffice;
                this.pageLoad = true;
            }
        });
